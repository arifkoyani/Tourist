...
const Indroduce = () => {
  return (
    <div className="flex flex-col bg-[#10623d] py-[100px] px-4 md:py-[200px] md:flex-row items-center justify-center">
      <div className="w-full md:w-1/2 p-8">
        <h1 className="text-2xl md:text-3xl font-bold mb-6 md:mb-12 font-serif text-white">
          Welcome to Pakistan Travel &amp; Tours!
        </h1>
